...
app 
 └ lib                              → Application sources 
    └ red_application_business_rules    → Application services layer
    ...
    └ yellow_enterprise_business_rules     → Enterprise core business layer
    ...
    └ blue_frameworks_drivers            → Frameworks, drivers and tools such as Database, the Web Framework, mailing/logging/glue code etc.
    ...
    └ green_interface_adapters            → Adapters and formatters for use cases and entities to external agency such as Database or the Web
